            ...
            <ScrollView>
                <View style={styles.container}>
                    ...
                    <View style={{ width: wp('95'), height: Platform.OS === 'ios' ? hp('7%') : hp('5%'), justifyContent: 'center', alignItems: 'center', marginTop: hp('8%') }}>
                        <Text style={{ color: '#505050', fontFamily: 'Montserrat-Bold', fontSize: 22 }}>Your Backup Phrase</Text>
                    </View>

                    <View style={{ width: wp('95'), height: Platform.OS === 'ios' ? hp('7%') : hp('5%'), justifyContent: 'center', alignItems: 'center', marginTop: hp('2%') }}>
                        <Text style={{ color: '#505050', fontFamily: 'Montserrat-Light', fontSize: 14 }}>Below is your twelve word backup phrase. Please write it down and keep it in a safe place.</Text>
                    </View>
